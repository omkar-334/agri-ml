...
from dataset import basic_transform, prepare_dataloaders
from Soyatrans.soyatrans import SoyaTrans
from Soyatrans.train import Trainer
...
for pct in percentages:
    pct_int = int(pct * 100)
    log_filename = f"logs/soyatrans_pungliya_{pct_int}pct.log"
