...
class MaiaNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.anti_aliasing_1 = AntiAliasingBlock(
            64, 64, downsample=False
        )  # 112×112×64 -> 112×112×64
        self.maia_1 = MaiaBlock(64, 256)  # 112×112×64 -> 112×112×256
        self.anti_aliasing_2 = AntiAliasingBlock(
            256, 512, downsample=True
        )  # 112×112×256 -> 56×56×512
        self.maia_2 = MaiaBlock(512, 512)  # 56×56×512 -> 56×56×512
        self.anti_aliasing_3 = AntiAliasingBlock(
            512, 1024, downsample=True
        ...
        self.global_pool = nn.AdaptiveAvgPool2d((
            1,
            1,
        ))  # Converts 14x14x2048 to 1x1x2048
        self.fc = nn.Linear(
            2048, num_classes
...
class HeadBlock(nn.Module):
    def __init__(self, in_channels, out_channels):
        super().__init__()
        self.conv = nn.Conv2d(
            in_channels, out_channels, kernel_size=7, padding=3, stride=2
        )
...
class MultiAttention(nn.Module):
    def __init__(self, in_channels):
        ...
        self.fca = MultiSpectralAttentionLayer(
            in_channels, 7, 7, reduction=16, freq_sel_method="top16"
        )
